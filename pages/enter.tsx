    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-1 ">
            {method === "email" 
                ? <input type="email" className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-400 focus:border-orange-500" required /> 
                : null
            }
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input type="number" className="rounded-l-none appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-400 focus:border-orange-500" required />
              </div>
            ) : null}
          </div>
